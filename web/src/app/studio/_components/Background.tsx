      ...
      >
        <div
          className={cn(
            ...
            "border border-white/5 backdrop-blur-[2px]",
            ...
            "after:bg-[radial-gradient(circle_at_50%_50%,rgba(255,255,255,0.03),transparent_3 0%)]",
          )}
        />
      </motion.div>
    </motion.div>
    ...
    <div className="relative min-h-screen w-full overflow-hidden bg-[#050505]">
      ...
      <div className="absolute inset-0 overflow-hidden opacity-100">
        <ElegantShape
          ...
          height={140}
          rotate={12}
          gradient="from-white/[0.04]" // Brighter
          className="top-[15%] left-[-10%] md:top-[20%] md:left-[-5%]"
        />
        ...
        <ElegantShape
          ...
          height={120}
          rotate={-15}
          gradient="from-zinc-400/[0.2]" // Brighter
          className="top-[70%] right-[-5%] md:top-[75%] md:right-[0%]"
        />
        <ElegantShape
          delay={0.7}
          ...
          height={100}
          rotate={-25}
          gradient="from-white/[0.02]" // Brighter
          className="top-[50%] left-[50%] md:top-[50%] md:left-[50%]"
        />
        <ElegantShape
          delay={0.4}
          width={300}
          height={80}
          rotate={-8}
          gradient="from-slate-400/[0.4]" // Brighter
